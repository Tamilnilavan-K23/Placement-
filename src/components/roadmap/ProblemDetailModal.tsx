        ...
        <div className="flex items-center justify-between p-6 border-b border-slate-800/80 bg-slate-950/40">
          ...
          <div className="flex items-center space-x-2">
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="flex items-center space-x-1.5 px-3 py-2 rounded-xl bg-brand-600 hover:bg-brand-500 text-white text-xs font-bold shadow-md shadow-brand-500/20 transition-all"
            ...
            <div className="flex items-center space-x-2">
              ...
              {!isTimerForThisProblem ? (
                <div className="flex items-center space-x-1">
                  <span className="text-[10px] text-slate-400 font-medium hidden sm:inline">Set Timer:</span>
                  {[15, 20, 30, 40].map(mins => (
                    <button
                      key={mins}
                      onClick={() => startTimer(problem.id, mins)}
                      className="px-2 py-1 rounded-lg bg-slate-800 hover:bg-amber-500/30 text-slate-300 hover:text-amber-300 text-[11px] font-bold border border-slate-700 transition-colors"
                    >
                      {mins}m
                    </button>
                  ))}
